...
- local AI infrastructure, guarded behind the product-specific runtime and settings.

The contract for reusable UI and program modules is in [docs/ui-program-architecture-tz.md](docs/ui-program-architecture-tz.md). The practical conversion guide is in [docs/creating-new-monitoring-app.md](docs/creating-new-monitoring-app.md).
...
The reference program builds and unit tests pass. Before publishing this project as an independent template repository, resolve the Git boundary and the remaining architectural items documented in [docs/template-readiness-review.md](docs/template-readiness-review.md).
