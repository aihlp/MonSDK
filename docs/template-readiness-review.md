...
2. **Keep program IDs out of common AI code.** `AiConversationContract.DEFAULT_PROGRAM_ID` was removed from AI persistence paths. Keep the guard tests and expand non-blood-pressure fixture coverage before release.
